...
APP_NAME="Serverless Ninja - Hate Inference";
...
AWS_CF_STACK_NAME="${ENVIRONMENT_NAME}-ninja-hate-inference-apis";

verifyInstallation() {
  printHeader;
  printSeparator;
  printColored "I am about to delete the stack for $APP_NAME with the following settings";
  printSeparator;
